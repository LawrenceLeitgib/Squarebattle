...
function detectionCollisionCub(rect, gameObject) {
  let leftOfMissle = rect.x;
  let rightOfMissle = rect.x + rect.width;
  let topOfMissle = rect.y;
  let bottomOfMissle = rect.y + rect.height;
