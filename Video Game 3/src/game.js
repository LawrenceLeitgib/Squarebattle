...
class Game {
  constructor(gameWidth, gameHeight) {
    ...
    this.helper = new Helper(this, {x:20,y:this.gameHeight-70-40}, {x:5,y:0}, 100, "rgb(26, 163, 47)",300);
  ...
  update(deltaTime) {
    ...
    if (this.gamestate === GAMESTATE.OPTION) {
      ...
      if (isInside(this.mousePosition, rect3) && this.clickDown) {
    ...
    if (this.gamestate === GAMESTATE.SHOP) {
      ...
      if (this.buyCount >= this.buyTime) {
        ...
        if (
          ...
          this.clickDown &&
          this.money >= this.addintionalCostRegen *(this.spaceShip.regenerationPourecent+0.1)*10
        ) {
          this.buyCount = 0;
          this.money -= this.addintionalCostRegen *(this.spaceShip.regenerationPourecent+0.1)*10;
          this.addintionalCostRegen += 1;
  ...
  draw(context) {
    ...
    context.fillRect(this.gameWidth - 150, 60, 150, 25);
    ...
    context.fillText("Money: " + this.money, this.gameWidth - 140, 80);
    context.textAlign = "center";
    context.fillText(
